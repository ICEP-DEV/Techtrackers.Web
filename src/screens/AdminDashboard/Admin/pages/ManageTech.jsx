    ...
    <div className={styles.headerContainer}>
      <header className={styles.header}>
        ...
        <div className={styles.headerRight}>
          <button className={styles.addTechnicianButton} onClick={handleAddTechnicianClick}>
            ADD TECHNICIAN
          </button>
        </div>
      </header>
...
const ManageTechniciansTable = () => {
  ...
  const handleRemoveTechnician = (technicianId) => {
    setTechnicians((prevTechs) => prevTechs.filter((tech) => tech.technicianId !== technicianId));
  ...
  if (selectedTechnician) {
    return (
      <TechnicianDetailView
        ...
        onRemove={handleRemoveTechnician} // Correctly passing the remove function
      />
    );
  }
        ...
        <tbody>
          {technicians.map((technician) => (
            <tr key={technician.technicianId}>
              ...
              <td>
                <button className={styles.viewButton} onClick={() => handleViewClick(technician)}>
                  Manage
                </button>
              </td>
            </tr>
