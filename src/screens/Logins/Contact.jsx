      ...
      <div className="contact-container">
        ...
        <div className="contact-details">
            <div className="contact-item">
              <img src={require('../ADMIN/images/checkCircle.png')} alt="Logo 1" className="contact-image" />
            ...
            <div className="contact-item">
              <img src={require('../ADMIN/images/checkCircle.png')} alt="Logo 2" className="contact-image" />
              <div className="contact-message">
            ...
            <div className="contact-item">
              <img src={require('../ADMIN/images/checkCircle.png')} alt="Logo 3" className="contact-image" />
              <div className="contact-message">
