  ...
  return (
    ...
    <div>
      ...
      <div className="image-item">
          <img src={require('../ADMIN/images/checkCircle.png')} alt="Service 1" className="service-image" />
        ...
        <div className="image-item">
          <img src={require('../ADMIN/images/checkCircle.png')} alt="Service 2" className="service-image" />
        ...
        <div className="image-item">
          <img src={require('../ADMIN/images/checkCircle.png')} alt="Service 3" className="service-image" />
        ...
        <div className="image-item">
          <img src={require('../ADMIN/images/checkCircle.png')} alt="Service 4" className="service-image" />
