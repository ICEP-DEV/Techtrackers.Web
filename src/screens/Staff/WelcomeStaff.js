  ...
  return (
    <div className={styles.mainContainer}>
      ...
      <div className={styles.cardsContainer}>
        {/* Log Issue Card */}
        <div
          className={`${styles.cards} ${styles.logIssue}`}
        ...
        >
          ...
          <div className={styles.cardsContent}>
            <h2>LOG ISSUE</h2>
            <p>
              Report a new technical problem or request assistance with
        ...
        {/* Status Card */}
        <div
          className={`${styles.cards} ${styles.cards}`}
        ...
        >
          ...
          <div className={styles.cardsContent}>
            <h2>STATUS</h2>
            <p>
              Check the progress of your reported issues, including pending,
              ongoing, and resolved cases.
            </p>
          </div>
        </div>
        ...
        {/* Notifications Card */}
        <div
          className={`${styles.cards} ${styles.cardn}`}
        ...
        >
          ...
          <div className={styles.cardsContent}>
            <h2>NOTIFICATIONS</h2>
            <p>
              Stay updated with the latest status changes and important alerts
