...
import styles from "../SidebarCSS/Tables.module.css";

export default function Table({ onSelectIssue, onOpenChat }) {
        ...
        <tbody>
          {issues.map((issue) => (
            <tr key={issue.issueId}>
              ...
              <td>
              <span className={`${styles.statusColor} ${styles[issue.status ? issue.status.toLowerCase() : 'unknown']}`}>
